...
public class CameraRotate : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        //{
        //    desiredDistance -= ControlFreak2.CF2Input.GetAxis("Mouse Y") * 0.02f * zoomSpeed * 0.125f * Mathf.Abs(desiredDistance);
        //}
        ...
        //desiredDistance -= ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") * 0.02f * zoomSpeed * Mathf.Abs(desiredDistance);
